...
export function ContactSection() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const response = await fetch("https://formspree.io/f/xreakjrw", {
        method: "POST",
        headers: {
          ...
          >
              ...
              {contactInfo.map((info) => {
                ...
                return (
                  <div key={info.title} className="flex items-center space-x-4">
                    <div
                      className={`w-12 h-12 ${info.color} rounded-lg flex items-center justify-center`}
                    >
            ...
            >
              ...
              <p className="text-muted-foreground text-sm leading-relaxed">
                ...
                Whether you need a Java backend system, web application development,
                or want to explore AI/ML projects, let's connect and create something
                amazing together!
              </p>
            </motion.div>
          </motion.div>
